...
.card__form{
    .upload{
        ...
        label{
            ...
            border-radius: 100px;
            background: imgurl( 'user-icon.png' ) center center no-repeat;
            cursor: pointer;
            transition: box-shadow .4s ease-out;

            &:hover{
                box-shadow: 0px 4px 8px rgba(47, 83, 151, 0.3);
            }
        }
